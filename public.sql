...
-- ----------------------------
-- Function structure for notify_admin_inventory_update_from_customer_when_stock_zero
-- ----------------------------
DROP FUNCTION IF EXISTS "public"."notify_admin_inventory_update_from_customer_when_stock_zero"();
CREATE FUNCTION "public"."notify_admin_inventory_update_from_customer_when_stock_zero"()
...
-- ----------------------------
CREATE TRIGGER "trigger_user_ordered_last_copy" AFTER UPDATE ON "public"."inventory"
FOR EACH ROW
WHEN (((old.quantity_in_stock IS DISTINCT FROM new.quantity_in_stock) AND (new.quantity_in_stock = 0)))
EXECUTE PROCEDURE "public"."notify_admin_inventory_update_from_customer_when_stock_zero"();
