...
INSERT INTO "public"."book" VALUES (13, 'Hamlet', 'Hamlet is a tragic play by Shakespeare that follows a prince’s quest for revenge against his father’s murderer, exploring themes of madness, betrayal, and mortality.', 'https://cdn-icons-png.flaticon.com/512/5402/5402751.png', 't', '3425654365343', 'Penguin Publications', '2019-07-01 00:00:00', NULL, NULL, NULL, 'f', 0.00, 0, 19.99);
INSERT INTO "public"."book" VALUES (14, 'Harry Potter', 'Fantasy Fiction book', 'https://cdn-icons-png.flaticon.com/512/5402/5402751.png', 't', '34256547363756', 'Bloomsburry Publishing Ltd.', '2010-08-01 00:00:00', NULL, NULL, NULL, 'f', 4.50, 2, 15.00);
...
-- Records of cart
-- ----------------------------
INSERT INTO "public"."cart" VALUES (1, 3, '2025-07-05 18:32:03.173854', '2025-07-30 10:57:29.186134');
...
INSERT INTO "public"."cart_item" VALUES (85, 1, 2, 1, 2);
...
INSERT INTO "public"."customer" VALUES (3, 'Mohibul Islam Sawrav', '2205018@ugrad.cse.buet.ac.bd', '$2b$10$RfOVcY9RIcmrXJ3GZty4Oep21SVA3Kj2rY5wcYCen/6/SCF30hVki', '+8801864316100', 'Dhaka, Bangladesh', '2025-07-01 22:53:03.887927', '2025-07-27 01:12:39.477666', '2025-07-30 10:57:06.519033', 'customer', 't');
...
SELECT setval('"public"."admin_notifications_notification_id_seq"', 7, true);
...
SELECT setval('"public"."author_author_id_seq"', 16, true);
...
SELECT setval('"public"."cart_item_cart_item_id_seq"', 85, true);
...
SELECT setval('"public"."inventory_inventory_id_seq"', 13, true);
